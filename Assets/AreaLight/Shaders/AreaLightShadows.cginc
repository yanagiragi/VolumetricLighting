...
half Shadow(half3 position)
{
    ...
    for (int j = 0; j < 10; ++j)
    {
        ...
        // Kind of like sampling for shadow map?
        // Except it sample 10 times only
    ...
    for (int i = 0; i < 32; ++i)
    {
        ...
        // variance Shadow mapping: return only depth > variance
